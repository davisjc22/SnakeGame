...
public class ScoreFrame extends JFrame{
	...
	**/
	...
	public static final String FILEDIR = "C:/SnakeScores";//<<<<<<<Change this to include your last name
	...
	public ScoreFrame( ScoreRecord scoreFromThisGame ){
		...
		display.setText("NAME\tTIME\tSCORE\n");//makes it look pretty
	...
	public void readFromFile(){
		try{		
			...
			if(br!=null){//if the file exists, read from it
				...
				while(read!=null){
					theScores.add( new ScoreRecord(read) );//
					read = br.readLine();
				}
	...
	public void writeToFile(){
		try{			
			...
			out.print( theScores.toFileString() );//writes to the file
