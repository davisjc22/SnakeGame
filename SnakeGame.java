...
public abstract class SnakeGame extends JPanel{
	...
	public SnakeGame(){
		this(difficultyPrompt());//Sets the difficulty
	}
	...
	public static double difficultyPrompt(){//sets the speed of the snake based on the difficulty chosen
		
		double choice = JOptionPane.showOptionDialog(null, "Difficulty", "Choose a Difficulty Level:", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, diffOptions, diffOptions[0]);
		if(choice == 0)
			choice = 1;
		else if(choice == 1)
			choice = .25;
